            ...
            <Flex direction="column" gap="4">
              <Flex gap="4">
                ...
                <Box style={{ flex: 1 }}>
                  ...
                  <Select.Root
                    value={selectedUbicacionA?.toString() || ""}
              ...
              <Box>
                ...
                <Select.Root
                  value={selectedModuloA?.toString() || ""}
            ...
            <Flex direction="column" gap="4">
              <Flex gap="4">
                ...
                <Box style={{ flex: 1 }}>
                  ...
                  <Select.Root
                    value={selectedUbicacionZ?.toString() || ""}
              ...
              <Box>
                ...
                <Select.Root
                  value={selectedModuloZ?.toString() || ""}
          ...
          <WizardStep>
            <Flex direction="column" gap="4">
              ...
              <Box>
                ...
                <Select.Root
                  value={selectedRuta?.toString() || ""}
                  onValueChange={(value) => setValue("ID_RutaUbicacion", parseInt(value), { shouldValidate: true })}
                  disabled={!selectedUbicacionZ}
                >
              ...
              <Box>
                ...
                <Select.Root
                  value={selectedTipoConexion?.toString() || ""}
